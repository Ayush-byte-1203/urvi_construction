...
const FloatingWhatsApp = () => {
  ...
  // Variables removed because the button now triggers the QuotePopup which handles WhatsApp details
  return (
    <button 
      onClick={() => window.dispatchEvent(new CustomEvent('openQuotePopup'))}
