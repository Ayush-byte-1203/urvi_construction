    ...
    <div className="about-page">
      ...
      <section className={styles.hero}>
        <div className="container">
          ...
          <h1 className="display-md" style={{ color: 'var(--text-primary)' }}>Who We Are</h1>
        ...
        <div className={styles.overviewSplit}>
          <MotionWrapper variant="slideRight" className={styles.overviewText}>
            ...
            <p className="text-body-md">
              At BuildCraft Constructions, we believe that premium landmark properties are defined by details. 
            ...
            <Link to="/contact" style={{ width: 'fit-content', marginTop: '0.5rem' }}>
              <Button variant="primary">Connect with an Estimator</Button>
            </Link>
          </MotionWrapper>
          ...
          <MotionWrapper variant="slideLeft">
            <MediaWrapper 
              ...
              alt="BuildCraft Engineering Staging"
              aspectRatio="4/3"
        ...
        <div className={styles.galleryGrid}>
          {galleryImages.map((src, idx) => (
            <MotionWrapper key={idx} variant="scale" delay={idx * 0.1} className="glass-panel" style={{ overflow: 'hidden' }}>
              <MediaWrapper 
                src={src} 
                alt={`BuildCraft Construction Operation ${idx + 1}`}
                aspectRatio="16/10"
      ...
      <CTA
        ...
        description="Let's coordinate on your structural design specifications. Request a preliminary site visit estimate call."
        primaryBtnText="Start Your Dream Project"
        primaryBtnLink="/contact"
        secondaryBtnText="Review Packages"
