...
const Services = () => {
  ...
  return (
    <div className="services-page">
      <Helmet>
        <title>Engineering Services Ecosystem | BuildCraft</title>
        ...
        <meta property="og:title"       content="Engineering Services Ecosystem | BuildCraft" />
        ...
        <meta name="twitter:title"      content="Construction Services | BuildCraft" />
      ...
      <section className={styles.ctaBanner}>
        <div className={`container ${styles.ctaContainer}`}>
          <h2>Ready to Deploy Our Design-Build Framework?</h2>
          <p>
            Schedule a site audit call with our engineers to verify structural soil capabilities and estimate material BOQ parameters today.
          </p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap', marginTop: '2rem' }}>
            <Link to="/contact" className="btn btn-primary">
              Schedule Free Site Consultation
            </Link>
            <Link to="/packages" className={`btn btn-secondary ${styles.btnSecTransparent}`}>
