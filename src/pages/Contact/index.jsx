...
const Contact = () => {
  ...
  return (
    <div className="contact-page">
      <Helmet>
        <title>Contact BuildCraft | Premium Construction Estimates</title>
        <meta name="description"        content="Get in touch for a free site assessment, engineering drawings review, or cost estimate. Book a consultation with BuildCraft today." />
        <link rel="canonical"           href={`${appConfig.seo.siteUrl}/contact`} />
        <meta property="og:type"        content="website" />
        <meta property="og:title"       content="Contact BuildCraft | Premium Construction Estimates" />
        ...
        <meta name="twitter:title"      content="Contact BuildCraft" />
      ...
      <section className={styles.hero}>
        <div className="container">
          ...
          <h1 className="display-md" style={{ color: 'var(--text-primary)' }}>Start the Dialogue</h1>
      ...
      {/* Office location branches & Interactive Map Section */}
      <section className="section" style={{ backgroundColor: 'var(--bg-secondary)', borderTop: '1px solid var(--color-border-subtle)' }}>
        <div className="container">
          <SectionHeader
            ...
            heading="Office Branch Locations"
            subheading="Find our regional design coordinates, engineering desks, and building yards locations."
          />

          <div className={styles.mapPlaceholder}>
            <div style={{ textAlignment: 'center', color: 'var(--color-text-muted)' }}>
              <MapPin size={36} style={{ color: 'var(--accent)', margin: '0 auto 1rem', display: 'block' }} />
              <span>Interactive Google Maps / Mapbox Frame Loader</span>
            </div>
          </div>
        </div>
      </section>
