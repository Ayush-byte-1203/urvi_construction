...
const Projects = () => {
  ...
  return (
    <div className="projects-page">
      <Helmet>
        <title>Portfolio & Case Studies | BuildCraft</title>
      ...
      <section className={styles.ctaBanner}>
        <div className={`container ${styles.ctaContainer}`}>
          <h2>Inspired by Our Completed Case Studies?</h2>
          <p>
            Schedule coordinate site inspections calls with our general contracting engineers to plan specifications today.
          </p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', marginTop: '2.5rem', flexWrap: 'wrap' }}>
            ...
            <Link to="/packages" className={`btn btn-secondary ${styles.btnSecOutline}`}>Estimate Cost Calculator</Link>
          </div>
        </div>
      </section>
    </div>
